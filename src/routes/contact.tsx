  ...
  head: () => ({
    meta: [
      { title: "Contact — Spice Garden Restaurant" },
      {
        name: "description",
        content:
          "Contact Spice Garden Restaurant in Tiruvallur. Call, WhatsApp or email us to place an order or enquire about party catering.",
      },
...
const contactSchema = z.object({
  ...
  people: z
    .string()
    .refine((v) => v === "" || (/^\d+$/.test(v) && +v >= 1 && +v <= 500), {
      message: "People must be between 1 and 500",
    }),
  ...
  return (
    <>
      <PageHero
        ...
        title="Place your order or |get in touch instantly.|"
        subtitle="We're here to help you with your cravings, catering needs, or any questions you have."
      />
      ...
      <section className="section-padding pt-0">
        <div className="container-x grid lg:grid-cols-3 gap-5 mb-10">
          {channels.map((c, i) => (
            ...
            >
              ...
              <span className="mt-4 inline-flex items-center gap-2 text-gold text-sm font-semibold">
                {c.cta} →
              </span>
            </a>
          ))}
        ...
        <div className="container-x grid md:grid-cols-2 gap-6">
          <div className="rounded-2xl border border-gold/20 bg-card p-7" data-aos="fade-right">
          ...
          <div className="rounded-2xl border border-gold/20 bg-card p-7" data-aos="fade-left">
            <div className="flex items-center gap-3 mb-4">
              <Clock className="w-6 h-6 text-gold" />
              <h3 className="font-display text-2xl">Quick Enquiry</h3>
            </div>
            <p className="text-muted-foreground text-sm leading-relaxed">
              Tap below to send us a WhatsApp message. We typically reply within minutes to confirm your order or answer any questions.
            </p>
        ...
        {/* ENQUIRY FORM */}
        <div className="container-x mt-10" data-aos="zoom-in">
          <div className="rounded-3xl border border-gold/30 bg-card/70 p-7 md:p-12 relative overflow-hidden">
            ...
            <div className="relative grid md:grid-cols-5 gap-10">
              <div className="md:col-span-2">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden border border-gold/20 mb-6 shadow-lg group">
                  <img
                    src={imgDelivery}
                    alt="Spice Garden Delivery"
                ...
                <p className="text-muted-foreground leading-relaxed text-sm">
                  Place your order or get in touch instantly. Our team responds within minutes to confirm your order, delivery time or party arrangements.
                </p>
              </div>
              ...
              <form
                onSubmit={onSubmit}
                noValidate
                className="md:col-span-3 grid sm:grid-cols-2 gap-4"
              >
                ...
                <div className="sm:col-span-1 grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={inputCls("people", "px-3")}
                    />
