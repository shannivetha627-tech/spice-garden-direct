  ...
  return (
    <section className="section-padding relative overflow-hidden">
      <div className="container-x">
        <div
          data-aos="zoom-in"
          className="relative rounded-3xl border border-gold/30 bg-gradient-to-br from-card via-background to-card p-8 md:p-16 text-center overflow-hidden"
        >
          ...
          <p className="text-muted-foreground max-w-xl mx-auto mb-8">
            Send us a quick message on WhatsApp and we'll take it from there — dine-in, delivery,
            takeaway or party orders.
          </p>
