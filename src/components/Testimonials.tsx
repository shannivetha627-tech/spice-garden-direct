...
const testimonials = [
  {
    ...
    text: "The food was fresh and tasted really good. Service was quick, and the overall experience was smooth and enjoyable.",
  },
  {
    name: "Meena K",
    role: "Homemaker, Chennai",
    text: "The restaurant is clean and well-maintained. I ordered food for home delivery and it arrived on time and was still hot.",
  },
  {
    name: "Arun V",
    role: "Business Owner, Chennai",
    text: "Good quantity for the price and consistent taste. It's a reliable place to order food regularly.",
  },
  {
    name: "Kavya R",
    role: "College Student, Chennai",
    text: "Ordering was very easy and the food quality was nice. Perfect place for quick meals with friends.",
  },
  {
    name: "Suresh M",
    role: "Manager, Chennai",
    text: "I ordered for a small gathering and the service was well organized. Food quality and delivery timing were both good.",
  },
];
